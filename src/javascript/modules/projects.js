...
export function createTestProjects() {
  ...
  let testTask_1 = Task("call your parents", ProjectsNotToRemove[5]);
  ...
  let testTask_2 = Task("car maintenance", ProjectsNotToRemove[5]);
  ...
  appBoard.projectsList[6].addTask(testTask_4);
  ...
  appBoard.projectsList[6].addTask(testTask_5);
  ...
  appBoard.projectsList[7].addTask(testTask_6);
  ...
  appBoard.projectsList[7].addTask(testTask_7);
  ...
  appBoard.projectsList[8].addTask(testTask_11);
  ...
  appBoard.projectsList[9].addTask(testTask_12);
  ...
  appBoard.projectsList[9].addTask(testTask_13);
  ...
  appBoard.projectsList[9].addTask(testTask_14);
}
